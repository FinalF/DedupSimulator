...
resample(Map<String, long[]> index,int M,Map<String, Long> cache,
		Map<Integer, Integer> containerRecord,int samplingRate,int newSamplingRate,
		int threshold,int chunkSize, int segSize, BloomFilter<String> bf,
		File bloomfilterRecord,String storageFileFolder,
